...
const About = () => {
  return (
    <section
      id="about"
      className="scroll-mt-24 py-4 px-[7vw] md:px[7vw] lg:px-[20vw] font-sans mt-16 md:mt-24 lg:mt-32"
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        <div className="md:w-2/3 text-center md:text-left mt-8 md:mt-0">
          ...
          <a
            href="https://drive.google.com/file/d/1YrxU-_tzKPGlKWCnwUIAtPu5sOjiHELZ/view?usp=drivesdk"
            target="_blank"
